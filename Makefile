...
GFORTRAN  			= gfortran
COMPILER_FLAGS 		= -fimplicit-none -fmodule-private -Wall -Wextra -Wconversion -std=f2018 -pedantic-errors -ffree-line-length-0 -Jbuild -ftest-coverage -fprofile-arcs
